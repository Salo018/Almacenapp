    ...
    <div class="container mt-4">
        ...
        <table class="table">
            ...
            <?php
                ...
                if ($response === false) {
                    curl_close($curl);
                    echo "<tr><td colspan='5'>Error al conectar con el microservicio de órdenes.</td></tr>";
                } else {
                    curl_close($curl);
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo number_format($totalCuenta, 2); ?></td>
                    <td><?php echo $fecha; ?></td>
                </tr>
            <?php
                        }
                    } else {
                        echo "<tr><td colspan='5' class='text-center'>No hay órdenes registradas</td></tr>";
                    }
                }
            ?>
            </tbody>
